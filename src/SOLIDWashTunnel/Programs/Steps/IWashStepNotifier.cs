...
namespace SOLIDWashTunnel.Programs.Steps
{
   ...
   *   On each wash step a notification is sent to all subscribers. The subscribers are outside of this project (See: 'Notifications' project).
   *   They can be used by the client/s, and provide extension methods which subscribe the particular subscriber they offer, to the 'WashStepNotifier'.
